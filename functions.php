...
function marsriva_scripts() {
    ...
    wp_enqueue_script( '56d1',   get_template_directory_uri() . "/assets/upload/js/56d1dc9e74114aa0a152b07725ffc960.js", array('bundle'),   1, true  ); 
    wp_enqueue_script( 'ac3d',   get_template_directory_uri() . "/assets/upload/js/ac3d.js", array('bundle'),   1, true  ); 
    wp_enqueue_script( 'sidebar',   get_template_directory_uri() . "/assets/upload/js/sidebar.js", array('jquery'),   1, true  ); 
    wp_enqueue_script( 'search',   get_template_directory_uri() . "/assets/upload/js/search.js", array('bundle'),   1, true  ); 
    wp_enqueue_script( 'tabs',   get_template_directory_uri() . "/assets/upload/js/tabs.js", array('bundle'),   1, true  ); 
