...
<div id="c_static_001-1716445880719">
                    ...
                    <div class="cbox-1-1 p_item">
                        <div class="e_container-2 s_layout">
                            <div class="cbox-2-0 p_item">
                                <h1 class="e_h1-3 s_subtitle">Серия KP3</h1>
                                        ...
                                        <li class="p_contentItem active">
                                            <p>
                                                <span style="line-height: 1">
                                                    • Благодаря 3 разъемам *DC и
                                                    1 разъему *USB серия KP3
                                                    способна одновременно питать
                                                    <strong>
                                                        несколько устройств. </strong
                                                    ><br />
                                                    •
                                                    <strong>
                                                        Технология
                                                        преобразования AC/DC 0
                                                        мс
                                                    </strong>
                                                    позволяет вашим устройствам
                                                    работать при
                                                    ...
                                                    на задней панели серию KP3
                                                    можно легко установить на
                                                    стену. <br />
                                                    •
                                                    <strong>
                                                        Система воздушного
                                                    ...
                                                    рассеивание тепла,
                                                    гарантируя долговременную
                                                    стабильность ИБП. <br />
                                                    •
                                                    <strong>
                                                        Корпус изделия с
                                                        огнезащитой класса V-0
                                                    </strong>
                                                    обеспечивает безопасность
                                                    вас и вашего имущества.
                                                    <br />
                                                    •
                                                    <strong>10000mAh</strong>
                                                    Высокоемкостная батарея
                                                    обеспечивает более
                                                    длительное время резервного
                                                    питания.&nbsp; <br />
                                                    •
                                                    <strong>
                                                        Выходная мощность 36 Вт
                                                    </strong>
                                                    (KP3 Pro) обеспечивает
                                    ...
                                    <div class="">
                                        <div class="p_list">
                                            <div class="cbox-50 p_loopitem">
                                                <div
                                                    class="e_foldItem-52 border showDetail"
                                                    needjs="true"
                                                >
                                    ...
                                    <div class="">
                                        <div class="p_list">
                                            <div class="cbox-57 p_loopitem">
                                                <div
                                                    class="e_container-59 s_layout"
                                                >
                                                    <div
                                                        class="cbox-59-0 p_item"
                                                    >
                                                        <div
                                                            class="e_container-60 s_layout"
                                                        >
                                                            <div
                                                                class="cbox-60-0 p_item"
                                                            >
                                                                <div
                                                                    class="e_icon-62 s_title"
                                                                >
                                                                    <svg
                                                                        t="1711093667896"
                                                                        class="icon"
                                                            ...
                                                            <div
                                                                class="cbox-60-1 p_item"
                                                            >
                                                                <p
                                                                    class="e_text-63 s_title"
                                                                >
                                                                    <a
                                                                        href="https://omo-oss-file110.thefastfile.com/portal-saas/pg2025012411115407946/cms/file/kp3 series catalogue-v1.pdf"
                                                                        target="_self"
                                                                    >
                                                                        Каталог
                                                                        серии
                                                    ...
                                                    <div
                                                        class="cbox-59-1 p_item"
                                                    >
                                                        <div
                                                            class="e_loop_sub-64 s_list"
                                                        >
                                                            <div
                                                                class="cbox-64 p_loopItem"
                                                            >
                                                                <p
                                                                    class="e_text-65 s_title"
                                                                >
                                                                    <svg
                                                                        t="1711094163814"
                                                                        class="icon"
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <a
                                                                        href="https://omo-oss-file110.thefastfile.com/portal-saas/pg2025012411115407946/cms/file/dc ups datasheet marsiva_ru.pdf"
                                                                        target="_self"
                                                                    >
                                                                        Каталог
                                                                        Мини-ИБП
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <a
                                                                        href="https://omo-oss-file110.thefastfile.com/portal-saas/pg2025012411115407946/cms/file/kp3 series user manual_ru.pdf"
                                                                        target="_self"
                                                                    >
                                                                        DC ИБП.
                                                                        Серия
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <a
                                                                        href="https://omo-oss-file110.thefastfile.com/portal-saas/pg2025012411115407946/cms/file/kp3s user manual_ru.pdf"
                                                                        target="_self"
                                                                    >
                                                                        DC ИБП.
                                                                        Серия
			...
			<script id="tpltool_ExtractJs">
				...
				$(function () {
					$(".e_container-42 .Products_imst:nth-child(1)").addClass(
						"active"
					);
					$(".e_productTabList-90 .p_nameItem:nth-child(1)").addClass(
						"active"
					);
				...
				$(".e_container-49 .e_text-54").click(function () {
					var textContent = $(".e_container-49 .e_text-54").text();
					console.log(textContent);
					if (textContent == "Expand All") {
						console.log(1);
						$(".e_container-49 .e_loop-50 .e_foldItem-52").addClass(
							"showDetail"
						);
						$(this).text("Collapse All");
					} else if (textContent == "Collapse All") {
						console.log(2);
						$(".e_container-49 .e_loop-50 .e_foldItem-52").removeClass(
							"showDetail"
						);
