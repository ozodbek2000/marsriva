...
!(function (e, t) {
    ...
    function b(e, t, n, r, o) {
        for (
            ...
            if ((i = e[p]) || 0 === i)
                if ("object" === h(i)) de.merge(f, i.nodeType ? [i] : i);
                else if (Xe.test(i)) {
                    for (
        ...
        for (c.textContent = "", p = 0; (i = f[p++]); )
            if (r && -1 < de.inArray(i, r)) o && o.push(i);
                ...
                ((u = Ie(i)), (a = v(c.appendChild(i), "script")), u && x(a), n)
            )
                for (l = 0; (i = a[l++]); ) ze.test(i.type || "") && n.push(i);
        return c;
    }
    function a() {
        return !0;
    ...
    function D(e, t) {
        ...
        if (1 === t.nodeType) {
            if (je.hasData(e) && (i = je.get(e).events))
                for (o in (je.remove(t, "handle events"), i))
                    for (n = 0, r = i[o].length; n < r; n++)
                        de.event.add(t, o, i[o][n]);
            qe.hasData(e) &&
                ((e = qe.access(e)), (e = de.extend({}, e)), qe.set(t, e));
        }
    }
    function j(n, r, o, i) {
        r = ee(r);
        ...
        if (
            h ||
            (1 < f && "string" == typeof d && !ue.checkClone && Je.test(d))
        )
        ...
        if (
            ...
            if (s)
                for (
                    l = a[a.length - 1].ownerDocument, de.map(a, N), c = 0;
                    c < s;
                    c++
                )
                    (u = a[c]),
    ...
    function R(e, t, n, r, o, i) {
        ...
        for (; a < 4; a += 2)
            "margin" === n && (u += de.css(e, n + Re[a], !0, o)),
                r
                    ? ("content" === n &&
                          (u -= de.css(e, "padding" + Re[a], !0, o)),
                      "margin" !== n &&
                          (u -= de.css(e, "border" + Re[a] + "Width", !0, o)))
                    : ((u += de.css(e, "padding" + Re[a], !0, o)),
                      "padding" !== n
                          ? (u += de.css(e, "border" + Re[a] + "Width", !0, o))
                          : (s += de.css(
    ...
    function $(o, e, t) {
        ...
        return (
            ...
            de.fx.timer(
                de.extend(u, { elem: o, anim: l, queue: l.opts.queue })
            ),
            l
        );
    }
    ...
    (de.fn = de.prototype =
            ...
            isPlainObject: function (e) {
                return !(
                    ...
                    ((e = K(e)) &&
                        ("function" !=
                            typeof (e =
                                ie.call(e, "constructor") && e.constructor) ||
                            ae.call(e) !== se))
                );
            },
        ...
        "function" == typeof Symbol &&
            (de.fn[Symbol.iterator] = J[Symbol.iterator]),
        de.each(
    ...
    var he = (function (n) {
            ...
            if (!r && (j(t), (t = t || q), H)) {
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            ((f = (ve.test(e) && d(t.parentNode)) || t) === t &&
                                m.scope) ||
                                ((s = t.getAttribute("id"))
                                    ? (s = s.replace(be, we))
                    ...
                    e != q &&
                        ...
                        _ != q &&
                            ...
                            (t.addEventListener
                                ...
                                : t.attachEvent &&
                                  t.attachEvent("onunload", c)),
                        (m.scope = r(function (e) {
                            return (
                                L.appendChild(e).appendChild(
                                    q.createElement("div")
                                ),
                                void 0 !== e.querySelectorAll &&
                        ...
                        (m.getElementsByClassName = ye.test(
                            ...
                            (r(function (e) {
                                ...
                                (L.appendChild(e).innerHTML =
                                    ...
                                    e.querySelectorAll("[id~=" + I + "-]")
                                        .length || O.push("~="),
                                    (t = q.createElement("input")).setAttribute(
                                        "name",
                                        ""
                                    ),
                                    e.appendChild(t),
        ...
        return (
            ...
            (m.sortDetached = r(function (e) {
                return (
                    1 & e.compareDocumentPosition(q.createElement("fieldset"))
                );
            })),
            r(function (e) {
                return (
    ...
    ((de.fn.init = function (e, t, n) {
        ...
        return (
            (e = ce.getElementById(r[2])) && ((this[0] = e), (this.length = 1)),
            this
        );
    }).prototype = de.fn),
        (xe = de(ce));
            ...
            when: function (e) {
                function t(t) {
                    return function (e) {
                        (o[t] = this),
                            (i[t] =
                                1 < arguments.length ? Z.call(arguments) : e),
                            --n || a.resolveWith(o, i);
                    };
                }
    ...
    function ke(e, t, n, r, o, i, a) {
        var s = 0,
            ...
            l = null == n;
        if ("object" === h(n))
            for (s in ((o = !0), n)) ke(e, t, s, n[s], !0, i, a);
        else if (
            void 0 !== r &&
            ((o = !0),
            le(r) || (a = !0),
            ...
            queue: function (e, t, n) {
                ...
                if (e)
                    return (
                        ...
                        n &&
                            (!r || Array.isArray(n)
                                ? (r = je.access(e, t, de.makeArray(n)))
                                : r.push(n)),
                        r || []
                    );
            },
    ...
    Me.getRootNode &&
        (Ie = function (e) {
            return (
                ...
                e.getRootNode(_e) === e.ownerDocument
            );
        });
    var We = function (e, t) {
            return (
    ...
    (de.event = {
                    ...
                    n.handler && ((n = (i = n).handler), (o = i.selector)),
                        ...
                        (a = h.handle) ||
                            (a = h.handle =
                                function (e) {
                                    return void 0 !== de &&
                                        de.event.triggered !== e.type
                                        ? de.event.dispatch.apply(t, arguments)
                                        : void 0;
                                }),
                        u = (e = (e || "").match(Ce) || [""]).length;
                    u--;
        ...
        dispatch: function (e) {
            var t,
                ...
                s = de.event.fix(e),
                u =
                    (je.get(this, "events") || Object.create(null))[s.type] ||
                    [],
            ...
            if (
                ...
                for (
                    i = de.event.handlers.call(this, s, u), t = 0;
    ...
    de.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        i = i || v(e), a = a || v(c), r = 0, o = i.length;
                        r < o;
                        r++
                    )
                        D(i[r], a[r]);
            ...
            return (
                0 < (a = v(c, "script")).length && x(a, !f && v(e, "script")), c
            );
        },
        ...
        de.each(
            ...
            function (e, a) {
                de.fn[e] = function (e) {
                    for (
                        var t, n = [], r = de(e), o = r.length - 1, i = 0;
                        i <= o;
                        i++
                    )
    ...
    de.extend({
        ...
        de.each(["height", "width"], function (e, s) {
            de.cssHooks[s] = {
                get: function (e, t, n) {
                    if (t)
                        return !yt.test(de.css(e, "display")) ||
                            (e.getClientRects().length &&
    ...
    (de.Animation = de.extend($, {
        tweeners: {
            "*": [
                function (e, t) {
                    ...
                    return y(n.elem, e, Pe.exec(t), n), n;
                },
            ],
        },
        tweener: function (e, t) {
            for (
                var n,
                    r = 0,
                    o = (e = le(e) ? ((t = e), ["*"]) : e.match(Ce)).length;
                r < o;
                r++
            )
                (n = e[r]),
                    ...
                    p))
                        u ||
                            (g
                                ...
                                : (g = je.access(e, "fxshow", { display: l })),
                            i && (g.hidden = !h),
                            h && m([e], !0),
                            f.done(function () {
                                for (r in (h || m([e]),
        ...
        (Oe = ce
            ...
            .appendChild(ce.createElement("option"))),
        (pe.type = "checkbox"),
        (ue.checkOn = "" !== pe.value),
                    ...
                    return void 0 === e.getAttribute
                        ...
                        : ((1 === i && de.isXMLDoc(e)) ||
                              (o =
                                  ...
                                  (de.expr.match.bool.test(t) ? Et : void 0)),
                          void 0 !== n
                              ? null === n
                ...
                return "boolean" == typeof t && a
                    ...
                    : this.each(function () {
                          ...
                          if (a)
                              ...
                              (void 0 !== o && "boolean" !== i) ||
                                  ((e = U(this)) &&
                                      je.set(this, "__className__", e),
                                  this.setAttribute &&
                                      this.setAttribute(
                                          "class",
                                          (!e &&
                                              !1 !== o &&
                                              je.get(this, "__className__")) ||
                                              ""
                                      ));
                      });
            },
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (
                            ...
                            ((r = o[a]).selected =
                                -1 <
                                de.inArray(de.valHooks.option.get(r), i)) &&
                                (n = !0);
    ...
    de.extend(de.event, {
        trigger: function (e, t, n, r) {
            ...
            if (
                3 !== n.nodeType &&
                8 !== n.nodeType &&
                !jt.test(p + de.event.triggered) &&
                (-1 < p.indexOf(".") &&
                    ((p = (d = p.split(".")).shift()), d.sort()),
                (s = p.indexOf(":") < 0 && "on" + p),
                ((e = e[de.expando]
                    ? e
                    : new de.Event(p, "object" == _typeof(e) && e)).isTrigger =
                    r ? 2 : 3),
                (e.namespace = d.join(".")),
                ...
                for (o = 0; (h = f[o++]) && !e.isPropagationStopped(); )
                    (c = h),
                        ...
                        (u =
                            (je.get(h, "events") || Object.create(null))[
                                e.type
                            ] && je.get(h, "handle")) && u.apply(h, t),
                        (u = s && h[s]) &&
                            u.apply &&
                            Ae(h) &&
                    ...
                    r ||
                        ...
                        (s &&
                            ...
                            e.isPropagationStopped() &&
                                c.addEventListener(p, Dt),
                            n[p](),
                            e.isPropagationStopped() &&
                                c.removeEventListener(p, Dt),
        ...
        simulate: function (e, t, n) {
            e = de.extend(new de.Event(), n, { type: e, isSimulated: !0 });
            ...
            ajax: function (e, t) {
                function n(e, t, n, r) {
                    ...
                    p ||
                        ...
                        !r &&
                            -1 < de.inArray("script", h.dataTypes) &&
                        ...
                        (w.statusText = (t || s) + ""),
                        r
                            ? m.resolveWith(g, [o, s, w])
                            : m.rejectWith(g, [w, s, i]),
                        w.statusCode(x),
                        (x = void 0),
                        d &&
                ...
                h.ifModified &&
                    ...
                    de.etag[l] &&
                        w.setRequestHeader("If-None-Match", de.etag[l])),
    ...
    de.ajaxSetup({
        ...
        (ue.createHTMLDocument =
            (((pe = ce.implementation.createHTMLDocument("").body).innerHTML =
                "<form></form><form></form>"),
            ...
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  t ||
                      (ue.createHTMLDocument
                          ? (((r = (t =
                                ce.implementation.createHTMLDocument(
                                    ""
    ...
    $.ajax({ url: "https://".concat(ENV_PREFIX, "omo.aiyouyi.cn/domain") })
        .done(function (o) {
            if (o) {
                for (var t in o)
                    "timeout" != t &&
                        (s[t] = "https://".concat(o[t], ".aiyouyi.cn"));
                var n = s || {},
                    i = n.hy,
                    a = n.cx,
                    e = n.dd,
            ...
            : /pre-/.test(tenant.makeDomain) && (o = "pre"),
        {
            ...
            shopItemUrl:
                (null === doMain || void 0 === doMain
                    ? void 0
                    : doMain.shopItemUrl) || domainConfig.shopItemUrl,
            shopYxUrl:
                (null === doMain || void 0 === doMain
                    ? void 0
                    : doMain.shopYxUrl) || domainConfig.shopYxUrl,
            shopMemberUrl:
                (null === doMain || void 0 === doMain
                    ? void 0
            ...
            shopCartUrl:
                (null === doMain || void 0 === doMain
                    ? void 0
                    : doMain.shopCartUrl) || domainConfig.shopCartUrl,
            shopOrderUrl:
                (null === doMain || void 0 === doMain
                    ? void 0
                    : doMain.shopOrderUrl) || domainConfig.shopOrderUrl,
        }
    );
}
...
!(function (global, setTimeout) {
    ...
    function each(e, t) {
        if (e)
            for (var n = 0; n < e.length && (!e[n] || !t(e[n], n, e)); n += 1);
    }
    ...
    function eachProp(e, t) {
        for (var n in e) if (hasProp(e, n) && t(e[n], n)) break;
    }
            ...
            (req.load = function (t, n, i) {
                ...
                if (isBrowser) {
                    (e = req.createNode(r, n, i)).setAttribute(
                        ...
                        !$compDebug &&
                            /^\/npublic/.test(i) &&
                            (i = i.replace(/.{1}js$/, ".min.js"));
                    var a = function (e) {
                        var t, n, i, r, a;
                        return (
                            ("pre" == tenant.siteType ||
                                "oper" == tenant.siteType) &&
                                ((a = ""),
                                2 == tenant.cdnFlag &&
                                    (null == __ce.staticCount &&
                                        (__ce.staticCount = 0),
                                    (r =
                                        __ce.staticCount %
                                        __ce.staticUrl.length),
                                    __ce.staticCount++,
                                    (a =
                                        __ce.staticUrl[r] ||
                                        __ce.staticUrl[0])),
    ...
    function newContext(p) {
        ...
        function E(e, t, n) {
            var i = e.id,
                r = getOwn(c, i);
            !hasProp(f, i) || (r && !r.defineEmitComplete)
                ? (r = A(e)).error && "error" === t
                    ? n(r.error)
                    : r.on(t, n)
                : "defined" === t && n(f[i]);
        ...
        function S(t, e) {
            ...
            e
                ...
                : (each(n, function (e) {
                      ...
                      e &&
                          ((e.error = t),
                          e.events.error && ((i = !0), e.emit("error", t)));
                  }),
                  i || req.onError(t));
        }
        function q() {
        ...
        function o(e) {
            hasProp(f, e[0]) || A(x(e[0], null, !0)).init(e[1], e[2]);
        }
        function a(e, t, n, i) {
            ...
            ((e = function (e) {
                ...
                check: function () {
                    if (this.enabled && !this.enabling) {
                        ...
                        } else hasProp(u.defQueueMap, i) || this.fetch();
                    }
                },
                callPlugin: function () {
                    var s = this.map,
            ...
            ((u = {
                        ...
                        a ||
                            (s.undef = function (n) {
                                ...
                                (t.undefed = !0),
                                    ...
                                    delete u.defQueueMap[n],
                                    t &&
                                        (t.events.defined && (i[n] = t.events),
                                        M(n));
                            }),
                        s
                    );
                ...
                nameToUrl: function (e, t, n) {
                    var i,
                        ...
                        s,
                        p = getOwn(m.pkgs, e);
                    if ((p && (e = p), (p = getOwn(g, e))))
                        return u.nameToUrl(p, t, n);
                    if (req.jsExtRegExp.test(e)) o = e + (t || "");
                    else {
                        for (
                            i = m.paths, a = (r = e.split("/")).length;
                            0 < a;
                            --a
                        )
                            if ((s = getOwn(i, r.slice(0, a).join("/")))) {
...
_require.config({
    ...
    paths:
        ...
        _defineProperty(_paths, "fancybox", nuPath + "fancybox/fancybox.umd"),
        _defineProperty(_paths, "ncaptcha", nuPath + "ncaptcha/ncaptcha"),
        _defineProperty(_paths, "verify", nuPath + "ncaptcha/js/verify"),
        _defineProperty(_paths, "e3dImages", plPath + "e3dImages"),
        _paths),
    shim: {
        bMap: { exports: "BMap" },
        tMap: { exports: "TMap" },
        ...
        fancybox: { deps: ["css!" + nuPath + "fancybox/fancybox"] },
        verify: { deps: ["css!" + nuPath + "ncaptcha/css/verify"] },
    },
});
var getParentWindow = function () {
    ...
    $comp = function (e) {
        for (var n = e, t = 0; t < n.lib.length; t++) {
            var i = n.outJs ? "" : "/npublic/js/";
            n.lib[t] = baseOrigin + i + n.lib[t];
        }
        e = window.ActiveXObject || "ActiveXObject" in window ? "polyfill" : "";
        _require([e], function (e) {
            _require(n.lib, function (e) {
                var t = $compCl.getScope(n.id);
                (e._params = n),
                    (e.scope = t),
                    e.init(),
                    t.attr("loaded", "true");
    ...
    $element = function (e, n, i) {
        ...
        _require([needPolyfill], function (e) {
            _require(r.lib, function (e) {
                ...
                (e._params = r), (e.scope = i || t), e.init(), n && n();
            });
        });
    },
    doCompJs = function (e) {
        var t,
            ...
            r,
            i = $("#" + e),
            a = (a = i.children('[name="propJson"]').val())
                ? JSON.parse(a)
                : {};
        a.needjs &&
            (-1 <
                (n =
                    a.styleId ||
                    (((n = e.split("_"))[n.length - 1] = n[
                        n.length - 1
                    ].substring(0, 3)),
                    n.join("_"))).indexOf("_P_") && (n = n.split("_P_")[0]),
            0 < i.find("input[name='compOutjs'][for='" + n + "']").length &&
                (t = i.find("input[name='compOutjs'][for='" + n + "']").val()),
            (r = { id: e, lib: [n + ".js"] }),
            t && ((r.lib = [t]), (r.outJs = !0)),
    ...
    doElementJs = function (e, t, n, i, r) {
        var a = $("#" + n + " ." + e);
        if ("true" == a.attr("needJs")) {
            var o = e.split("-")[1];
            o && o.indexOf("__") && (o = o.split("__")[0]);
            var s = e.split("-")[0],
                p = { cid: n, sd: i, id: e, lib: [s + ".js"] };
                ...
                a.children("input:hidden").each(function (e, t) {
                    ...
                    if (i && "propJson" != n) {
                        ...
                        if ("i18nJson" == n) {
                            ...
                            for (e in i)
                                e.endsWith("_" + o)
                                    ? (r[e.substring(0, e.lastIndexOf("_"))] =
                                          i[e])
                                    : -1 == e.indexOf("_") && (r[e] = i[e]);
                            p[n] = r;
                        } else p[n] = i;
                    }
                }),
    ...
    readyFun = function () {
        ...
        $require(
            [needPolyfill, e + "/npublic/commonjs/language/" + t + ".js"],
            function (e, t) {
                            ...
                            $("div[id^='c_popbox']").each(function (e, t) {
                                ...
                                n
                                    ...
                                    "true" ===
                                        ...
                                        ((t = n.attr("id").split("-")[1]),
                                        openDialog(t)),
                                    n.on("click", ".p_background", function () {
                                        "true" ===
                                            $(this).parent().attr("bg-close") &&
                                            n.find(".p_close").trigger("click");
                                    });
                            }),
                            e.lazyImg();
                    });
    ...
    pdfPreview = function (n, i, r, a, e, t, o) {
        localStorage.setItem(
            "nodownload" + tenant.tenantId,
            e ? "true" : "false"
        ),
            localStorage.setItem(
                "noprint" + tenant.tenantId,
                t ? "true" : "false"
            );
        t = -1 < n.indexOf("?") ? n.split("?")[0] : n;
                      ...
                      : (o
                            ? r && i
                                ? ((e = "/viewfilebizce/"
                                      .concat(i, "/")
                                      .concat(
                                          a ? encodeURIComponent(a) : "0.pdf"
                                      )),
                                  a && sessionStorage.setItem(i, a))
                                : (/^http:/.test(t) &&
                                      (t = t.replace(/^http:/, "https:")),
                                  (e = "/viewfilebizce/h/".concat(
                                      encodeURIComponent(t)
                                  )))
                            : r && i
                            ? ((e = "/npublic/opdfjs/web/viewer.html?u=" + i),
                              a &&
                                  ((e =
                                      e + "&fileName=" + encodeURIComponent(a)),
    ...
    fileDownloadFun = function (e, t, n) {
        var i, r;
        e &&
            ((i = [
                "site.cn",
            ...
            (/^http/.test(e) && -1 == i.indexOf(getDomain(e))) ||
                /^ftp/.test(e) ||
                ...
                n
                    ? ((n = ""),
                      -1 < e.indexOf("?") &&
                          ((e = (r = e.split("?"))[0]), (n = r[1])),
                      ((r = e.split("/"))[r.length - 1] = encodeURIComponent(
                          r[r.length - 1]
                      )),
                      (r = r.join("/")),
                      n && (r = r + "?" + n),
                      /^http:/.test(r) && (r = r.replace(/^http:/, "https:")),
                      (r = "/downfilebizce/get?n=".concat(
                          encodeURIComponent(r)
                      )),
                      (i.href = r))
                    : ((i.download = t), (i.href = e)),
                (i.target = "_blank"),
                document.body.appendChild(i),
                i.click(),
                document.body.removeChild(i)));
    },
    getShopImg = function (e, t, n) {
        var i, r;
        return (
...
function setHistory() {
    ...
    !window.pageObj ||
        ...
        (n =
            pageObj.appId + "_" + pageObj.contentType + "_" + pageObj.pageType),
    ...
    -1 < a
        ...
        localStorage.setItem(
            "history_".concat(tenant.tenantId),
            JSON.stringify(e)
        );
}
...
function mostLanguage() {
    $require(["pl_util"], function (e) {
        ...
        n.hasOwnProperty("lang") &&
            localStorage.setItem(
                "stopMostLanguage" + window.tenant.tenantId,
                !0
            ),
            n.hasOwnProperty("lang") ||
                "true" ==
    ...
    window.pageObj &&
        ...
        $require(["pl_util", "cmsAjax"], function (e, t) {
            ...
            void 0 !== a._preview &&
                ...
                a._preview_id &&
                ($("body").append(
                    '<div style="width:100%;background:#f2f2f2;color:#F56C6C;font-weight:bold;text-align:center;padding:10px;border-bottom:1px solid #ccc;position:fixed;top:0;left:0;z-index:9999999">当前为预览模式，预览有效期过后将无法访问，请勿将预览链接用作正式使用。</div>'
                ),
        ...
        e.cmsAjax.get("/fwebapi/cms/staff/getStaff").then(function (t) {
            ...
            t &&
                ...
                $require(
                    [
                        "pl_service",
                        e + "/npublic/commonjs/language/" + n + ".js",
                    ],
                    function (e) {
        ...
        isFrontEnv() &&
            ...
            $require([e], function (e) {
                ...
                "portal-saas-shop" == tenant.unittype
                    ...
                    getLixiaoCode(),
                    (location.hostname != tenant.makeDomain &&
                        location.hostname != tenant.mobileMakeDomain) ||
                        highLightKeywords(),
                    (location.hostname != tenant.domain &&
                        location.hostname != tenant.mobileDomain) ||
            ...
            !window.pageObj ||
                ("af96174b-39ab-430a-a049-013fbaedc0p1" !=
                    window.pageObj.pageId &&
                    "af96174b-39ab-430a-a049-013fbaedc0m2" !=
                        window.pageObj.pageId) ||
                gohomeFromBlank());
}),
    (function () {
        var urlSearchMap = function () {
            ...
            registerCodeParse = function (e) {
                var t =
                    (e = $.trim(e.replace(/-/g, ""))).substring(0, 0) +
                    e.substring(3);
                ...
                var hasLogging =
                    ...
                    logging = function logging(item) {
                        return (
                            hasLogging &&
                                eval(
                                    "console.warn('[risk interceptor]:', item);"
                                ),
                            null
                        );
                    };
        ...
        configure &&
            ...
            interceptor(
                0 <= configure.indexOf("--enable-dom-interceptor-logging")
            );
    })();
