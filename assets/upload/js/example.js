...
$(function () {
    ...
    $(".e_navigationF-24 .p_navItem1 .sj_warp")
        .find(".p_level3Box")
        .parents(".p_navItem1")
        .addClass("pro_li");
    $(".e_navigationF-24 .pro_li .dropdown .left ul .p_navItem2")
        .eq(0)
        .addClass("cur");
    $(".e_navigationF-24 .pro_li .dropdown .center .sj_warp ul")
        .eq(0)
        .addClass("pro_cur");

    if (wind_w > 768) {
        $(".e_navigationF-24 .pro_li .dropdown .left ul").on(
            "mouseenter",
            "li",
            function () {
